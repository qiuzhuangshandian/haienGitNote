...
picSavePath = "E:/papers/for_journal/may_target/codes/DrawForPaper/pictures/comparationGBT"
    ...
    for step in range(8,9):
        ...
        for size in cutLength:
            ...
            for trainIndex, testIndex in kf.split(X_set):
                ...
                # print(test_label)
                clf = GradientBoostingClassifier(n_estimators=num_trees,learning_rate=0.1,max_depth=5,random_state=0)
        ...
        acc_save = {"acc": acc_c}
        with open(jsonPath + "GTBacc.json", 'w') as f:
